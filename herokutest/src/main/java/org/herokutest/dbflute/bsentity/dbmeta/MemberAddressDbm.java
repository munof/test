...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "INTEGER", 10, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_238C98CA_5DF8_4E54_8515_FC53A01D6BA4", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.herokutest.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "org.herokutest.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "org.herokutest.dbflute.exbhv.MemberAddressBhv"; }
