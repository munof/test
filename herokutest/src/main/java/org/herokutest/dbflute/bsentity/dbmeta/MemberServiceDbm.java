...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, "会員サービスID", Integer.class, "memberServiceId", null, true, true, true, "INTEGER", 10, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_D3F4543B_EDC2_429F_8B39_04E8DEEC1C44", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.herokutest.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "org.herokutest.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "org.herokutest.dbflute.exbhv.MemberServiceBhv"; }
