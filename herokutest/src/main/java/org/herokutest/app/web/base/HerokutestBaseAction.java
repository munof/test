 ...
 */
package org.herokutest.app.web.base;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalThing;
import org.herokutest.app.logic.context.AccessContextLogic;
import org.herokutest.app.web.base.login.HerokutestLoginAssist;
import org.herokutest.app.web.base.view.HeaderBean;
 ...
 * @author jflute
 */
public abstract class HerokutestBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<HerokutestMessages>, HerokutestHtmlPath {
    ...
    @Override
    protected OptionalThing<HerokutestUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<HerokutestMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public HerokutestMessages createMessages() { // application may call
        return new HerokutestMessages(); // overriding to change return type to concrete-class
    }
