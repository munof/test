...
import org.herokutest.mylasta.direction.HerokutestEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface HerokutestConfig extends HerokutestEnv {

    /** The key of the configuration. e.g. herokutest */
    ...
    String COOKIE_REMEMBER_ME_HARBOR_KEY = "cookie.remember.me.herokutest.key";
     ...
     * The value is, e.g. herokutest <br>
    ...
    /**
     * Get the value for the key 'cookie.remember.me.herokutest.key'. <br>
     * The value is, e.g. HRB <br>
     * comment: The cookie key of remember-me for Herokutest #change_it_first
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeHerokutestKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends HerokutestEnv.SimpleImpl implements HerokutestConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(HerokutestConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(HerokutestConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(HerokutestConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(HerokutestConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(HerokutestConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(HerokutestConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(HerokutestConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(HerokutestConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(HerokutestConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(HerokutestConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeHerokutestKey() {
            return get(HerokutestConfig.COOKIE_REMEMBER_ME_HARBOR_KEY);
        }
    }
}
