 ...
 * @author jflute
 */
public class HerokutestCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = HerokutestUserTimeZoneProcessProvider.centralTimeZone;
