 ...
 */
public class HerokutestMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(HerokutestMultipartRequestHandler.class);
    ...
    protected void throwTooLongBoundarySizeException(String contentType, int boundarySize, int limitSize) {
        ...
        br.addElement(" in " + HerokutestMultipartRequestHandler.class.getSimpleName() + ".");
