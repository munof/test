 ...
 * @author jflute
 */
public class HerokutestSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public HerokutestSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
