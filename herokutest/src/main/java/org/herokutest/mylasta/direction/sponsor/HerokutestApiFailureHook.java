...
import org.herokutest.mylasta.direction.sponsor.HerokutestApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class HerokutestApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
